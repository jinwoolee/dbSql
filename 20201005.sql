...
1. 인위적으로 여러개의 행을 만들기
  ...
  EX : '202010' ==> 31
       날짜가 있으면 원하는 항목(년, 월, 일, 시, 분, 초)만 추출할 수 있따
       TO_CHAR(날짜, '원하는항목')
    ...
    FROM
      (SELECT TO_DATE('201912', 'YYYYMM') + LEVEL-1 day,
             TO_CHAR(TO_DATE('201912', 'YYYYMM') + LEVEL-1, 'D') d,
             TO_CHAR(TO_DATE('201912', 'YYYYMM') + LEVEL-1, 'IW') iw
       FROM dual
